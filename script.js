    ...
    // Daten für Ausflüge 
        galleryItems = [
            ...
            },
            {
                ...
                description: "Unser Ausflug führte uns nach Freiburg. Wir fuhren um 7.30 Uhr an der Kirche los und machten unterwegs den 1. Stopp in Altenheim, wo es wie immer unser \"traditionelles Frühstück\" und einen kleinen Morgenimpuls gab. In Freiburg erwarteten uns zwei Führungen durch die Altstadt, eine davon war etwas kürzer und abgestimmt auf die Teilnehmerinnen, die schlechter zu Fuß waren. Nach einem eher kleinen Mittagessen im Cafe Inklusiv (nahe beim Arbeitsplatz unseres Erzbischofs), sahen wir uns einen kurzen Film zum Inneren des Freiburger Münsters an. Danach hatten wir 2 Stunden zur freien Verfügung, wo wir auf den Schlossberg mit seiner herrlichen Aussicht fahren oder gehen konnten, das Münster besuchten oder einfach nur eine entspannte Pause im Stadtgarten oder einem der zahlreichen Cafés machten. Auf der Rückfahrt machten wir noch einmal Pause in Rastatt um zu Abend zu essen. Gegen 20.30 Uhr kehrten wir zurück."
            },
            {
                id: 3,
                title: "Weißenburg",
                ...
                description: "Wir besuchten den Ursprungsort von Weißenburg und standen vor der Abteikirche St. Peter und Paul. Wer sich unter einer Abteikirche nicht so recht was vorstellen kann: Dies meint, es ist eine Kirche innerhalb eines Klosters. Die Abteikirche war der Blickpunkt von Weißenburg. An dieser Stelle wurde im 7. Jahrhundert ein Benediktinerkloster gegründet. Die hier wirkenden Mönche erarbeiteten sich einen beträchtlichen Einfluss, so dass die Abtei bald zu den reichsten im Heiligen Römischen Reich gehörte. Das Benediktinerkloster wurde von einem Bischof aus unserer Gegend, vom Bischof Dragobodo aus Speyer gegründet. Diese heutige Kirche stammt aus dem 13. Jahrhundert, sie ist die zweitgrößte gotische Kirche im Elsass. Die Abteikirche hat im Inneren einiges zu bieten, vor allem die Christopherusdarstellung an der Ostwand der Kirche. Eine weitere Besonderheit ist ein Kreuzgang vom Anfang des 14. Jahrhunderts, der als einer der schönsten des Oberrheins angesehen wird. In der kleinen römischen Kapelle gibt es eine ganz besondere Fensterscheibe, die älteste Glasscheibe der Welt aus dem 11. Jahrhundert."
            },
            {
                id: 4,
                title: "Wertheim",
